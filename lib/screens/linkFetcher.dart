...
class LinkFetcher extends StatefulWidget {
 final int pageNo = 1;
  const LinkFetcher({Key? key}) : super(key: key);

  @override
  _LinkFetcher createState() => _LinkFetcher();
}

class _LinkFetcher extends State<LinkFetcher> {
  List movies = [];
   int pageNo = 1;
   var url;
  ...
  Future fetchData() async {
    url = Uri.parse("https://api.themoviedb.org/3/discover/movie?api_key=a78dda2b97306a1f556293bf49c50851&language=en-US&sort_by=popularity.desc&page=$pageNo&with_watch_monetization_types=flatrate");
